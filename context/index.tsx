...
const Provider = ({ children }: Props) => {
	...
	// 		const csrfToken = getCookie('_csrf'); // example to fetch from cookies
	...
	// 		// Now make the request to your API with the CSRF token
	// 		const response = await axios.get(' http://localhost:3100/api/v1/csrf-token', {
	// 		  headers: {
	...
	// 	  } catch (error) {
	// 		console.error('Error fetching CSRF token or making request:', error);
	// 	  }
	// 	};
